  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-900 transition-colors duration-200">
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 bg-white dark:bg-dark-800 p-3 rounded-full shadow-lg text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors"
      >
        {isDarkMode ? (
